      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('upload') }}" method="POST" id="modalUpload-form" enctype="multipart/form-data">
                @csrf
                <input type="file" name="upload_item">
            </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="$('#modalUpload-form').submit()">Upload</button>
          </div>
        </div>
      </div>
    </div>
